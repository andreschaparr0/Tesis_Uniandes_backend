...
\IfFileExists{chapters/05-diseno-implementacion.tex}{\input{chapters/05-diseno-implementacion}}{\chapter{Diseño, Arquitectura e Implementación} Contenido placeholder.}
\IfFileExists{chapters/06-experimentos-resultados.tex}{\input{chapters/06-experimentos-resultados}}{\chapter{Experimentos y Resultados} Contenido placeholder.}
\IfFileExists{chapters/07-discusion-amenazas.tex}{\input{chapters/07-discusion-amenazas}}{\chapter{Discusión y Amenazas a la Validez} Contenido placeholder.}
\IfFileExists{chapters/08-conclusiones-trabajo-futuro.tex}{\input{chapters/08-conclusiones-trabajo-futuro}}{\chapter{Conclusiones y Trabajo Futuro} Contenido placeholder.}
\makeatother

% ======= Apéndices =======
\appendix
\makeatletter
\IfFileExists{appendices/A-figuras-aplicacion.tex}{\input{appendices/A-figuras-aplicacion}}{\chapter{Figuras de la aplicación} Contenido placeholder.}
\IfFileExists{appendices/B-prompts.tex}{\input{appendices/B-prompts}}{\chapter{Prompts utilizados} Contenido placeholder.}
\IfFileExists{appendices/C-Api.tex}{\input{appendices/C-Api}}{\chapter{Documentación de la API} Contenido placeholder.}
\makeatother
